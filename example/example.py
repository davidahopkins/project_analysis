...
print("Welcome, this program converts feet & inches into decimal measurements.\
    \nPlease note that this program will continue taking input until \"stop\" is entered")
time.sleep(2)
stop_program = "stop"
while True:
